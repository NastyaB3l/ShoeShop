...
class CartRepository {
    ...
    suspend fun getCartItemsForCurrentUser(): Result<List<CartItem>> {
        ...
        return try {
            ...
            if (resp.isSuccessful) {
                ...
                Result.failure(kotlin.Exception(resp.errorBody()?.string()))
            }
        } catch (e: Exception) {
            Result.failure(e)
        }
    ...
    suspend fun addToCart(productId: String): Result<Unit> {
        ...
        return try {
            ...
            else Result.failure(kotlin.Exception(resp.errorBody()?.string()))
        } catch (e: Exception) {
            Result.failure(e)
        }
    }
    ...
    suspend fun removeFromCartByProduct(productId: String): Result<Unit> {
        ...
        return try {
            ...
            if (!respFind.isSuccessful) {
                return Result.failure(kotlin.Exception(respFind.errorBody()?.string()))
            }
            ...
            else Result.failure(kotlin.Exception(respDel.errorBody()?.string()))
        } catch (e: Exception) {
            Result.failure(e)
        }
    }
