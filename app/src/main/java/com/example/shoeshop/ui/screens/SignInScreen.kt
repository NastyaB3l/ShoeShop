...
fun SignInScreen(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            textStyle = customTypography.labelMedium, // Body Regular 16 для ввода текста
            singleLine = true
        )
        ...
        DisableButton(
            ...
            textStyle = customTypography.labelLarge // Body Medium 16 для текста кнопки
        )
                    ...
                    buildAnnotatedString {
                        withStyle(
                            style = SpanStyle(
                                ...
                                fontFamily = customTypography.labelMedium.fontFamily,
                                fontSize = customTypography.labelMedium.fontSize
                            )
                        ) {
